...
<x-layouts.app title="Login">
    <div class="flex items-center justify-center h-screen px-8 ">
        <div class="relative w-[34rem] bg-secondary rounded-t-lg pt-12">
            ...
            <div class="flex flex-col gap-y-8 mx-auto border py-14 shadow-xl bg-white">
                <button
                    class="absolute text-start pl-8 md:-translate-x-[70px] -translate-y-4 md:-translate-y-24 z-10 md:text-xl"
                    type="button" onclick="javascript:history.back()"> <- </button>
                        ...
                        <form action="#" method="POST" class="w-full"> @csrf
                            <div class="flex flex-col gap-8 px-8">
                                ...
                                <div class="grid relative">
                                    ...
                                    <button type="button"
                                        class="absolute end-0 bottom-0 -translate-y-12 -translate-x-3"
                            ...
                            "target": "#password"
                                ...
                                <div class="text-sm">
                                    <p>Don't have an account? <a href="/register"
                                            class="text-primary hover:underline">Sign Up
                                            here</a>
                                    </p>
                                </div>
                            </div>
